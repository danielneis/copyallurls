...
function copyallurls_initOptions(){
    try{
        ...
        if(oPrefs.prefHasUserValue("copyallurls.exceptionlist"))
            document.getElementById("copyallurls.exceptionlist").value = oPrefs.getCharPref("copyallurls.exceptionlist");
...
function copyallurls_saveOptions(){
    ...
    try{
        ...
        oPrefs.setCharPref("copyallurls.exceptionlist", document.getElementById("copyallurls.exceptionlist").value);
